...
alias bkncdb="cd \${AP_SC28_VAGRANT_VMS_DIR}/vg-nextcloud; vagrant ssh -c /home/vagrant/pnphuong29/projects/github.com/pnphuong29/ap-scripts-nextcloud-sc56/utils/ap_bk_nextcloud_db.sh"

# Backup Nextcloud source codes, data and DB
alias bkncall="gacpnc7; bkncdata; bkncdb"

# Restore Nextcloud DB from host machine
alias rtncdb="cd \${AP_SC28_VAGRANT_VMS_DIR}/vg-nextcloud; vagrant ssh -c /home/vagrant/pnphuong29/projects/github.com/pnphuong29/ap-scripts-nextcloud-sc56/utils/ap_rt_nextcloud_db.sh"
